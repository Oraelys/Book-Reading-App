// app/chat-room.tsx - Enhanced with keyboard-aware input and fixed media
...
import { ArrowLeft, Send, Image as ImageIcon, Video, MoreVertical, X } from 'lucide-react-native';
...
export default function ChatRoomScreen() {
  ...
  const handleSendImage = async () => {
    ...
    try {
      ...
      // Upload using proper file handling
